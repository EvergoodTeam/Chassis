...
public class ChassisLootTableProvider extends SimpleFabricLootTableProvider implements FabricDataGenerator.Pack.Factory<DataProvider> {
    ...
    public ChassisLootTableProvider(LootContextType lootContextType, ResourcePackBase resourcePack) {
        super(resourcePack.output, lootContextType);
